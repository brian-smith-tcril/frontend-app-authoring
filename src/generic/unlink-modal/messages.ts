...
const messages = defineMessages({
  ...
  description: {
    ...
    defaultMessage: 'Are you sure you want to unlink this library {categoryName} reference?' + ' Unlinked blocks cannot be synced. <b>Unlinking is permanent.</b>',
  ...
  descriptionChildren: {
    ...
    defaultMessage: '{childrenCategoryName} contained in this {categoryName} will remain linked to ' + 'their library versions.',
