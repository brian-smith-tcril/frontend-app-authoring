...
export const messages = defineMessages({
  ...
  errorCreateMessageWithDetail: {
    ...
    description: 'Message when creation of content in library is on error.' + ' The {detail} text provides more information about the error.',
  },
  ...
  errorPasteClipboardMessageWithDetail: {
    ...
    description: 'Message when pasting clipboard in library errors.' + ' The {detail} text provides more information about the error.',
  },
