...
const messages = defineMessages({
  ...
  selectLibraryNoLibrariesMessage: {
    ...
    defaultMessage: "You don't have any libraries created yet, or you don't have access to any libraries. To " + 'create a new library, go to Studio Home or contact your system administrator.',
