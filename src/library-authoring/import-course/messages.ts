...
const messages = defineMessages({
  ...
  helpAndSupportFirstQuestionBody: {
    ...
    defaultMessage: '<p>You can import existing courses into a library in order to reference ' + 'course content across courses.</p>' + '<p>Courses with content you or others may want to reuse or reference in the future are ' + 'excellent candidates for import.</p>',
  ...
  importCourseInProgressStatusBody: {
    ...
    defaultMessage: '{courseName} is being analyzed for review prior to import. For large courses, this may take some time.' + ' Please remain on this page.',
  ...
  importSuccessfulBody: {
    ...
    defaultMessage: 'Course {courseName} has been imported successfully.' + ' Imported Course content can be edited and remixed in your Library, and reused in Courses',
  ...
  importPartialAlertBody: {
    id: 'library-authoring.import-course.import-details.import-partial.alert.title',
    defaultMessage: '{courseName} has been imported to your library in a collection called {collectionName}.' + ' Some content was not added to your course. See details below.',
    description: 'Body of the alert in the import details page when the migration is in partial import.',
  },
  importPartialBody: {
    id: 'library-authoring.import-course.import-details.import-partial.alert.title',
    defaultMessage: '<p>{percentage}% of Course {courseName} has been imported successfully.' + ' Imported Course content can be edited and remixed in your Library, and reused in Courses.</p>' + '<p>Details of the import, including reasons some content was not imported are described below</p>',
  ...
  importBlockedBody: {
    ...
    defaultMessage: 'This import would exceed the Content Library limit of {limitNumber} items.' + ' To prevent incomplete or lost content, the import has been blocked. For more information,' + ' view the Content Library documentation.',
