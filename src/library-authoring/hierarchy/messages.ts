...
const messages = defineMessages({
  ...
  hierarchySections: {
    ...
    description: 'Text used for the section part of the hierarchy: show the displayName when there is one, or ' + 'the count when there is more than one.',
  },
  hierarchySubsections: {
    ...
    description: 'Text used for the subsection part of the hierarchy: show the displayName when there is one, or ' + 'the count when there is more than one.',
  },
  hierarchyUnits: {
    ...
    description: 'Text used for the unit part of the hierarchy: show the displayName when there is one, or ' + 'the count when there is more than one.',
  },
  hierarchyComponents: {
    ...
    description: 'Text used for the components part of the hierarchy: show the displayName when there is one, or ' + 'the count when there is more than one.',
  },
  publishSectionWithChildrenWarning: {
    ...
    defaultMessage: 'This section and the {childCount, plural, one {subsection} other {subsections}}' + ' it contains will all be <highlight>published</highlight>.',
  ...
  publishSubsectionWithChildrenWarning: {
    ...
    defaultMessage: 'This subsection and the {childCount, plural, one {unit} other {units}}' + ' it contains will all be <highlight>published</highlight>.',
  ...
  publishUnitWithChildrenWarning: {
    ...
    defaultMessage: 'This unit and the {childCount, plural, one {component} other {components}}' + ' it contains will all be <highlight>published</highlight>.',
  ...
  publishSubsectionWithParentWarning: {
    ...
    defaultMessage: 'Its {parentCount, plural, one {parent section} other {parent sections}}' + ' will be <highlight>draft</highlight>.',
  ...
  publishUnitWithParentWarning: {
    ...
    defaultMessage: 'Its {parentCount, plural, one {parent subsection} other {parent subsections}}' + ' will be <highlight>draft</highlight>.',
    description: 'Parent details shown before publishing a unit that has one or more parent subsections',
  },
  ...
  publishComponentsWithParentWarning: {
    ...
    defaultMessage: 'Its {parentCount, plural, one {parent unit} other {parent units}}' + ' will be <highlight>draft</highlight>.',
