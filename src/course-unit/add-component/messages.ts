...
const messages = defineMessages({
  ...
  modalComponentSupportTooltipFullySupported: {
    ...
    defaultMessage: 'Fully supported tools and features are available for Open edX installations, ' + 'are fully tested, have user interfaces where applicable, and are documented in the ' + 'official Open edX guides that are available on docs.openedx.org.',
  ...
  modalComponentSupportTooltipNotSupported: {
    ...
    defaultMessage:
      'Tools with no support are not maintained by the Open edX community, ' + 'and might be deprecated in the future. They are not recommended for use in ' + 'courses due to non-compliance with one or more of the base requirements, such as ' + 'testing, accessibility, internationalization, and documentation.',
