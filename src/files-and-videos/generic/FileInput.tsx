...
export const useFileInput = ({ onAddFile, setSelectedRows, setAddOpen }: UseFileInputArgs): FileInputVars => {
...
const FileInput = ({ fileInput: hook, supportedFileFormats, allowMultiple = true, id }: FileInputArgs) => {
  const intl = useIntl();
  return (
    <input
      id={id}
