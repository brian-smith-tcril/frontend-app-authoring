...
const messages = defineMessages({
  ...
  previouslyMigratedAlert: {
    ...
    defaultMessage: 'Previously migrated library. Any problem bank links were already' + ' moved will be migrated to <b>{libraryName}</b>',
  ...
  helpAndSupportFirstQuestionBody: {
    ...
    defaultMessage: 'In the new Content Libraries experience, you can author sections,' + ' subsections, units, and many types of components. Library content can be reused across many courses,' + ' and kept up-to-date. Content libraries now support increased collaboration across authoring teams.',
