...
const messages = defineMessages({
  ...
  importWizardStepReuploadBody: {
    ...
    defaultMessage: 'You may use any spreadsheet tool (for CSV files), or any text editor (for JSON files) to create ' + 'the file that you wish to import.' + '{br}Once the file is ready to be imported, drag and drop it into the box below, or click to upload.',
  },
  csvTemplateTitle: {
  ...
  importWizardStepPlanBody: {
    ...
    defaultMessage: 'Importing this file will make {changeCount} updates to the existing taxonomy. ' + 'The content of the imported file will replace any existing values that do not match the new values.' + '{br}Importing this file will cause the following updates:',
  },
  ...
  importWizardStepConfirmBody: {
    ...
    defaultMessage: 'Warning! You are about to make {changeCount} changes to the existing taxonomy. Any tags applied ' + 'to course content will be updated or removed. This cannot be undone.' + '{br}Are you sure you want to continue importing this file?',
  },
  promptTaxonomyName: {
