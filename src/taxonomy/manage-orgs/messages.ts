...
const messages = defineMessages({
  ...
  bodyText: {
    ...
    defaultMessage: 'Manage which organizations can access the taxonomy by assigning them in the menu below. You can ' + 'also choose to assign the taxonomy to all organizations.',
  },
  assignOrgs: {
  ...
  confirmUnassignText: {
    ...
    defaultMessage: 'Content authors from unassigned organizations will not be able to tag course content with ' + '{taxonomyName}. Are you sure you want to continue?',
  },
  continueButton: {
